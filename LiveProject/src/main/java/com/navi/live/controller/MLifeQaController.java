...
//import com.navi.live.validator.MLifeQaValidator;
...
//@RestController
//@RequestMapping("/mlifeqa")
//public class MLifeQaController {
//
//	private static final Logger logger = Logger.getLogger(MLifeQaController.class);
//
//	@Autowired
//	private MLifeQaService entityService;
//	private Convention sorting;
//
//	private @NonNull ResponseGenerator responseGenerator;
//	private @NonNull MLifeQaValidator validatorService;
//	private @NonNull MessagePropertyService messageSource;
//
//	@PostMapping(value = "/createOrUpdate", produces = "application/json")
//	public ResponseEntity<?> createOrUpdate(
//			@ApiParam(value = "Prod schemes request payload") @RequestBody MLifeQA request,
...
//
//		entityService.saveorupdate((MLifeQA) validationResult.getObject());
//
//		try {
//
...
//		try {
//
//			List<MLifeQA> obj = new ArrayList<MLifeQA>();
//			Page<MLifeQA> list = null;
//
