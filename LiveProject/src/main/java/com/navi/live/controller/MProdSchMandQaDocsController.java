...
//import com.navi.live.validator.MProdSchMandQaDocsValidator;
...
//@RestController
//@RequestMapping("/mprodschmandqadocs")
//public class MProdSchMandQaDocsController {
//
//	private static final Logger logger = Logger.getLogger(MProdSchMandQaDocsController.class);
//
//	@Autowired
//	private MProdSchMandQaDocsService entityService;
//	private Convention sorting;
//
//	private @NonNull ResponseGenerator responseGenerator;
//	private @NonNull MProdSchMandQaDocsValidator validatorService;
//	private @NonNull MessagePropertyService messageSource;
//
//	@PostMapping(value = "/createOrUpdate", produces = "application/json")
//	public ResponseEntity<?> createOrUpdate(
//			@ApiParam(value = "Prod schemes request payload") @RequestBody MProdSchMandQaDocs request,
...
//
//		entityService.saveorupdate((MProdSchMandQaDocs) validationResult.getObject());
//
//		try {
//
...
//		try {
//
//			List<MProdSchMandQaDocs> lob = new ArrayList<MProdSchMandQaDocs>();
//			Page<MProdSchMandQaDocs> pageLob = null;
//
